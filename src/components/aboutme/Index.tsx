...
export default function Index() {
    ...
    return (
      <>
       <div className={`grid h-screen lg:grid-cols-[1fr_3fr] md:grid-cols-1 items-center gap-x-10 px-5 relative text-center`} ref={container}>
          <motion.div style={{y : spring}} className="flex flex-col gap-5 self-center justify-center md:justify-center items-center xl:self-center lg:self-center md:self-center sm:self-center self-center lg:text-left items-center lg:items-start">
                <AboutMeDescription 
                  ...
                  <button>
                    <a href="" className="flex underline underline-offset-4 items-center font-bold gap-2">
